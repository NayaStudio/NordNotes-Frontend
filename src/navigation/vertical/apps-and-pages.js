export default [
  ...
  {
    title: 'Add new note',
    route: 'apps-notes-add',
    icon: 'MessageSquareIcon',
  },
  {
    title: 'Show shared',
    icon: 'MailIcon',
    route: { name: 'apps-notes-shared', params: { id: 0 } },
  },
  ...
  //     },
      // {
      //   title: 'Preview',
      //   route: { name: 'apps-notes-preview', params: { id: 4987 } },
      // },
      // {
      //   title: 'Edit',
      //   route: { name: 'apps-notes-edit', params: { id: 4987 } },
      // },
  //     {
  //       title: 'Add new',
  //       route: { name: 'apps-notes-add'},
  //       icon: 'FileTextIcon',
  //       children: [
  //         {
  //           title: 'List notes',
