export default [
...

  {
    ...
    component: () => import('@/views/apps/client/client-list/ClientList.vue'),
  },
  ...
  // *===============================================---*
  {
    path: '/apps/notes',
    name: 'apps-notes',
    component: () => import('@/views/apps/notes/notes-list/NotesList.vue'),
    // meta: {
    //   contentRenderer: 'sidebar-left',
  ...
  {
    path: '/apps/notes/edit/:id',
    name: 'apps-notes-edit',
    component: () => import('@/views/apps/notes/note-edit/NoteEdit.vue'),
  },
  {
    path: '/apps/notes/add',
    name: 'apps-notes-add',
    component: () => import('@/views/apps/notes/note-add/NoteAdd.vue'),
  },
  {
    path: '/apps/notes/shared',
    name: 'apps-notes-shared',
    component: () => import('@/views/apps/notes/notes-list/NotesSharedList.vue'),
  },

  {
    path: '/note/:id',
    name: 'apps-note',
    component: () => import('@/views/apps/notes/NoteShared.vue'),
    meta: {
      layout: 'full',
    },
  },
