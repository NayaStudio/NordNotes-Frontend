    ...
    <template #code>
      {{ codeSnow }}
            ...
            <b-card-body class="invoice-padding form-item-section">
              ...
              >
                <b-row
                  v-for="(item, index) in noteData.items"
                  :key="index"
                  ref="row"
                  class="pb-2"
                >
            ...
            <b-card-body class="invoice-padding pt-0">
              ...
              <b-form-textarea v-model="noteData.note" />
            </b-card-body>
          </b-card>
        </b-form>
      </b-col>
      ...
      >
        ...
        <div class="mt-2">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <label for="shareNote">Share this note</label>
            <b-form-checkbox
              id="shareNote"
              :checked="false"
              switch
...
import {
  BRow, BCol, BCard, BCardBody, BButton, BCardCode, BCardText, BForm, BFormGroup, BFormInput, BInputGroup, BInputGroupPrepend, BFormTextarea, BFormCheckbox, BPopover, BAlert, BLink, VBToggle,
} from 'bootstrap-vue'
...
export default {
  ...
  methods: {
    addNewItemInItemForm() {
      ...
      this.noteData.items.push(JSON.parse(JSON.stringify(this.itemFormBlankItem)))
  ...
  setup() {
    ...
    const updateItemForm = (index, val) => {
      ...
      noteData.value.items[index].cost = cost
      noteData.value.items[index].qty = qty
      noteData.value.items[index].description = description
    }
